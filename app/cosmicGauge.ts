...
export default function CosmicGauge() {
  ...
  async function runGauge() {
    setStatus("Measuring Base state…");
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 960, margin: "56px auto", fontFamily: "system-ui" }}>
        <h1>CosmicGauge — Built for Base</h1>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <button onClick={runGauge} style={{ padding: "6px 12px" }}>
            Run Gauge
          </button>
        ...
        <div style={{ marginTop: 12 }}>
          ...
          <Connected>
            <div style={{ marginTop: 10 }}>
              <div style={{ marginBottom: 6 }}>Address to inspect:</div>
              <input
                value={address}
